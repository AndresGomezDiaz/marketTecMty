...
if(isset($registro)){ $ligaUrl = base_url().'slider/SliderAlta/guardarSlider/'.$registro; }else{ $ligaUrl = base_url().'slider/SliderAlta/guardarSlider'; }
?>
<div class="row-fluid">
	<div class="span12">
			...
			<div class="widget-content nopadding">
				<?=form_open_multipart($ligaUrl,$attributes)?>
					...
					<div class="control-group <?=empty(form_error('texto')) ? "" : "error"?>">
						...
						<div class="controls">
							<input type="text" name="texto" id="texto" class="span11 m-wrap" value="<?=$texto?>">
					...
					<div class="control-group">
						...
						<div class="controls">
							<img src="<?=base_url().'assets/img/slider/'.$imagen?>" width="100%" class="span5 m-wrap">
							<span class="help-inline">La imagen tiene que ser en un tamaño mínimo de 1140 * 700 pixeles optimizada para web</span>
						</div>
					</div>
					<?php }else{ ?>
					<div class="control-group">
					...
					<div class="form-actions text-right">
						...
						<a href="<?=base_url().'slider_home'?>" class="btn">Cancelar</a>
					</div>
				<?=form_close()?>
			</div>
		</div>
